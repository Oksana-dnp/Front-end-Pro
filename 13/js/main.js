...
for (var index = 0; index < usersInfo.length; index++) {
    ...
    address: <br> street: ${usersInfo[index].address.street} <br>
    suite: ${usersInfo[index].address.suite} <br>
    city: ${usersInfo[index].address.city} <br>
    phone: ${usersInfo[index].phone} <br>
